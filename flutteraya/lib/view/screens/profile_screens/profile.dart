                          ...
                          children: [
                            Positioned(
                              ...
                              child: Container(
                                  ...
                                  child: CircleAvatar(
                                      backgroundImage:
                                          FileImage(File(MyCache.getString(key: "image"))),
                                      radius: 45.sp)),
                            )
                          ],
                        ),
                            ...
                            return Padding(
                              ...
                              child: ListTile(
                                onTap: () => Navigator.of(context).pushAndRemoveUntil(
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            _generalRoutes[index]),(route)=>route.isActive),
